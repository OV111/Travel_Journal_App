    ...
    <React.Fragment>
      <form onSubmit={handleSubmit} className="grid items-center gap-3 py-3">
        <div className="grid w-200 px-4 py-3 mx-30 bg-gray-50 border-2 border-gray-200 rounded-xl focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all duration-300 text-gray-900 placeholder-gray-500 placeholder:font-light">
          ...
          <input type="text" placeholder="Share Destination name" onChange={(e) => {setDestination(e.target.value)}}/>
          <input type="date" onChange={(e) => {setDate(e.target.value)}}/>
          <input type="text" placeholder="Enter Description of the Trip" onChange={(e)  => {setDescription(e.target.value)}}/>
